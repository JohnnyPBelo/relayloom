...
| FR-007 | Group conversations and membership authorization | partial | `docs/GROUP-CONFIRMATIONS.md` — Envio/recibos históricos e audiência original em Node/Go, factos completos preservados e incomplete superseded; gate completo host/interoperabilidade/UI/desktop passou. Eventos, carriers, UI dinâmica, plataformas e revisão independente pendentes. |
...
| FR-012 | Durable offline outbox | partial | `docs/GROUP-CONFIRMATIONS.md` — Envio/recibos históricos e audiência original em Node/Go, factos completos preservados e incomplete superseded; gate completo host/interoperabilidade/UI/desktop passou. Eventos, carriers, UI dinâmica, plataformas e revisão independente pendentes. |
| FR-013 | Delivery and expiry states | partial | `docs/GROUP-CONFIRMATIONS.md` — Envio/recibos históricos e audiência original em Node/Go, factos completos preservados e incomplete superseded; gate completo host/interoperabilidade/UI/desktop passou. Eventos, carriers, UI dinâmica, plataformas e revisão independente pendentes. |
