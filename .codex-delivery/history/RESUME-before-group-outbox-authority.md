...
Iteração local seguinte: autoridade da outbox dinâmica em implementação (ficheiros group-outbox/outbox/protected-private/node/group-content/group-commands, Node/Go; testes group-outbox). Ver GROUP-OUTBOX-INTEGRATION.md para estados/logs/limites exactos. Preservar todas as alterações não commitadas. Não atribuir os gates do marco5845515 a esta árvore posterior. CI34728934069/fde529e em curso na última observação: Node3OS passou, Go em execução; consultar apenas antes de tirar conclusões Apple/desktop.
