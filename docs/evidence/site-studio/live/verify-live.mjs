...
const out='.cache/site-studio/live';mkdirSync(out,{recursive:true});
...
try{
 ...
 for(const [name,args] of [
  ['studio',['scripts/e2e.mjs','--config','tests/browser/browser.config.ts','tests/browser/site-studio.spec.ts']],
