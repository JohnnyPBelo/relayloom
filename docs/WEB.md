...
- `packages/browser/src/crypto.ts`: Ed25519/X25519 de `@noble/curves`2.4.0, Web Crypto HKDF/SHA256 e AES256-GCM, cartões assinados, manifestos/chunks v1 e acesso por destinatário. Scrypt de `@noble/hashes`2.4.0, MIT, mantém o formato do cofre e os parâmetros existentes. Nada de primitivas criptográficas inventadas ou polyfills de Node no navegador.
