...
3. Executar os controlos novos de rede/partição/heal/multi-adapter/seeder, autorização/corrupção e interface; recompilar os artefactos móveis correspondentes e repetir os gates nativos disponíveis. A falha iOS na fotografia precisa de uma hipótese/correcção verificável antes de nova tentativa; não repetir a preparação inalterada.
