  ...
  for (const engine of ["chromium", "firefox", "webkit"]) {
    await check(
      ...
      [
        ...
        "tests/browser/site-resource-budget.spec.ts",
        "tests/browser/site-resources-ui.spec.ts",
        "tests/browser/site-resource-languages.spec.ts",
        "tests/browser/site-resource-recovery-ui.spec.ts",
        "tests/browser/site-resource-review.spec.ts",
        ...
        "tests/browser/large-site-draft.spec.ts",
