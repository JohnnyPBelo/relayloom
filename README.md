...
O próximo incremento são formulários e contribuições assinadas. O contrato criptográfico já tem testes Node/Go/browser, incluindo recusa de assinaturas adulteradas, base/esquema diferentes, expiração e divulgação não autorizada. **Ainda não há envio, caixa de propostas ou aprovação de formulários na interface.** Essa integração continua obrigatória. [Contrato, provas e limites](docs/evidence/site-contributions/clock-alignment).
